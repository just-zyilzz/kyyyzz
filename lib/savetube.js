...
const savetube = {
    ...
    getCDN: async () => {
        // Try multiple times to mitigate rate limits on production
        for (let i = 0; i < 3; i++) {
        ...
        return { status: false, code: 502, error: 'Failed to resolve SaveTube CDN' };
    },
        ...
        try {
            ...
            return {
                ...
                result: {
                    ...
                    format: format,
                    thumbnail: decrypted.thumbnail || `https://i.ytimg.com/vi/${id}/mqdefault.jpg`,
