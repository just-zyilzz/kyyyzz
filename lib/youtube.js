...
async function downloadVideo(url, quality = '720') {
    try {
        ...
        const proxyUrl = `/api/youtube-proxy?url=${encodeURIComponent(downloadUrl)}&title=${encodeURIComponent(title)}&type=video`;
...
async function downloadAudio(url) {
    try {
        ...
        const proxyUrl = `/api/youtube-proxy?url=${encodeURIComponent(downloadUrl)}&title=${encodeURIComponent(title)}&type=audio`;
